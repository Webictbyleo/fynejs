"use strict";const t=Array.isArray,e=Array.from,i=Object.keys;'use strict'
const t=t,e=function(){const e=e,s=t,i=i,n=(...t)=>{},o='style',r='display',c='none',h='tagName',f='TEMPLATE',l='length'
let u=1
const a='0'!=typeof document?document:null
...
s.push(e),this.M.set(t,s)}constructor(t,e,s){this._=0,this.$=0,this.l=null,this.u=0,this.p=0,this.m=0,this.k=0,this.D=[],this.t=null,this.O={},this.R={},this.A=new Map,this.S=new Map,this.T=new Map,this.C=null,this.F=0,this.j=0,this.P=0,this.M=new Map,this.I=new Set,this.q=[],this.B=new WeakMap,this.L=new Map,this.N=new Map,this.W=null,this.U=0,this.K=[],this.Z=new WeakMap,this.J=new WeakMap,this.V=null,this.X=t=>{if(!t)return void this.A.clear()
...
return this.I.add(e),()=>{try{this.I.delete(e)}catch{}}},this.it=(t,e,s,i)=>{t.addEventListener(e,s,i),this.q.push({element:t,event:e,handler:s,options:i})},this.o=t,this.h=s,this.nt=e.methods||{},this.O=e.computed||{},this.R=e.propEffects||{},this.P=!(!e.computed||!i(e.computed).length),this.H={mounted:e.mounted,unmounted:e.unmounted||e.destroyed,updated:e.updated,beforeMount:e.beforeMount,beforeUnmount:e.beforeUnmount||e.beforeDestroy},this.st=this.ot(e.data||{}),this.rt=this.ct()}callBeforeMount(){this.k||(this.G('beforeMount'),this.k=1)}ht(t){if(this.isBound){this.X(t)
...
return this.F=0,this.C=null,this.A.set(t,i),i}catch{return this.F=0,void(this.C=null)}}dt(t){if(!this.W)return
let e=this.N.get(t)
e||(e=[],this.N.set(t,e)),e.includes(this.W)||e.push(this.W)}ft(){this.U||(this.U=1,requestAnimationFrame(()=>{if(this.U=0,this.yt(),this.K&&this.K.length){const t=this.K.splice(0,this.K.length)
for(const e of t)try{e()}catch{}}}))}Y(t,e,s){try{return t()}catch(t){return s}}bindToElement(t){this.u||(this.l=t,this.k||this.callBeforeMount(),this.completeBinding())}getContext(t=1){return this.tt(t)}vt(){if(this.l){try{this.wt(this.l)}catch{}this.ft()}}completeBinding(){!this.u&&this.l&&(this.h.bt(this.l)||this.h.xt(this.l,this),this.u=1,this.p=1,this.wt(this.l),this.gt(),this.yt(),this.G('mounted'))}i(t){this.D.includes(t)||this.D.push(t)}Mt(t){const e=this.D.indexOf(t)
...
t.q=[]
for(const e of e(t.I))try{e()}catch{n()}if(t.I.clear(),t.A.clear(),t.L.clear(),t.N.clear(),t.V&&t._t)for(const e of t.V.N.values()){const s=e.indexOf(t._t)
s>-1&&e.splice(s,1)}t.l&&t.h.$t(t.l),t.G('unmounted'),t.m=1,t.p=0,t.u=0,t.D=[],t.t=null,this.kt=new WeakMap,t.l=null,queueMicrotask(()=>t.h.Et(t.o))}}Dt(t,e){if(!t||!e)return
let s
this.V=e
try{s=Function('ctx','with(ctx){return ('+t+')}')}catch{return}const i=()=>{let t
e.W=i
try{const i=e.getContext(1)
t=s(i)}catch{t=null}if(e.W=null,t&&'object'==typeof t){this.st.$props=this.st.$props||{},this._=1
for(const e in t){const s=t[e]
this.st[e]!==s&&(this.st[e]=s)}this._=0}}
this._t=i,i()}wt(t){const e=this,s=(t,s=0)=>{s||!t.hasAttribute(p('data'))&&!this.h.bt(t)||return0
const i='COMPONENT'===t[h],n=[]
let o=0,r=null
for(const e of t.attributes){const t=e.name;(t.startsWith(y+'-')||t.startsWith(y+':'))&&(n.push(e),o||t!==p('text')&&t!==p('html')||(o=1),r||t!==p('for')||(r=e))}if(n.length>0){if(r)return e.Ot(t,r.name,r.value),0
for(const s of n)e.Ot(t,s.name,s.value)}return s||!i}
s(t,1),e.Rt(t,s)}At(t){const e=e(t.childNodes)
...
if(!('model'===r?(t.removeAttribute(e),i.It(t,s),1):'if'===r?(t.removeAttribute(e),i.qt(t,s),1):'for'===r&&(t.removeAttribute(e),i.Bt(t,s),1))&&r.indexOf(':')>-1){const[n,o]=r.split(':',2),[c,...h]=o.split('.'),f=h.reduce((t,e)=>(e&&(t[e]=1),t),{})
if('on'===n){t.removeAttribute(e)
const n=i.framework.Lt(c)
return n?i.Nt(t,c,s,n,f):i.Wt(t,c,s,f)}return t.removeAttribute(e),i.Ft(t,c,s)}}jt(t,e){}zt(t,e){e&&e()}Ut(t,e){e&&e()}Kt(t,e){let s=0
const i=()=>{if(!s){s=1
...
if(s(),u&&e&&0===e.Zt){let t=0
for(const e of this.N.values())if(e.includes(s)){t=1
...
f.update=l}It(t,e){const s='checkbox'===t.type,i='number'===t.type||'range'===t.type,n='SELECT'===t.tagName&&1===t.multiple
Reflect.has(this.st,e)||Reflect.defineProperty(this.st,e,{configurable:1,enumerable:1,writable:1})
const o=this.Tt(e,t),r=this.Jt(e+' = $value',1),c=s?(()=>{if(t.hasAttribute('value'))return t.value
const e=this.Vt(t)
if(e){const t=i(e)
if(1===t.length)return e[t[0]]}return t.value})():0
this.Ct(()=>(e=>{if(s)if(t(e)){const s=t.hasAttribute('value')?t.value:c
t.checked=null!=s&&e.includes(s)}else t.checked=!!e
else{if(n){const s=t,i=t(e)?e:[]
...
this.it(t,u,()=>{const e=(()=>{if(s)return t(o())&&0!==c?t.checked?c:0:t.hasAttribute('value')?t.checked?t.value:0:t.checked
if(n){const e=t,s=[]
...
if(s&&t(h)){const e=h,s=t.hasAttribute('value')?t.value:c
if(0!==s){const i=e.indexOf(s)
t.checked?-1===i&&e.push(s):i>-1&&e.splice(i,1)}}else if(n&&t(h)){const t=h
...
return e.style[r]='contents',e.appendChild(t.content.cloneNode(1)),{el:e,isTemplate:1}}return{el:t,isTemplate:0}})(t),c=s.Tt(e,t)
n.push({el:o.el,test:c,isTemplate:o.isTemplate}),o.isTemplate||(o.el.Gt=1)
const u=[t]
let y=-1
for(const t of u)t.parentNode&&t.parentNode.removeChild(t)
const p=e=>{if(0>e)return
const o=n[e]
o.el.Gt||(s.wt(o.el),o.el.Gt=1),t.Ht?.parentNode?.removeChild(t.Ht),o.el.parentNode||(i.parentNode?.insertBefore(o.el,i.nextSibling),this.zt(o.el)),t.Ht=o.el,y=e},d=(t,e)=>{if(0>t)return void(e&&e())
const s=n[t]
...
0!==e&&v.push(e)}const x=b.length>0||y.ctrl||y.alt||y.shift||y.meta,g=v.length>0,M=d||w,$=e=>{if(f&&e.target!==t&&return0,M){e instanceof TouchEvent||return0
{const t=e.touches.length
d&&1!==t&&return0,w&&2>t&&return0}}if(g&&(e instanceof MouseEvent||return0,v.includes(e.button)||return0),x){e instanceof KeyboardEvent||return0
const t=(e.key||'').toLowerCase()
b.length>0&&!b.includes(t)&&return0,y.ctrl&&!e.ctrlKey&&return0,y.alt&&!e.altKey&&return0,y.shift&&!e.shiftKey&&return0,y.meta&&!e.metaKey&&return0}return1},k=!!r
let O=null
const E=o.tt()
...
this.et(s)}else o.it(t,e,A,h)}Jt(t,e=0){const s=`${e?'s':'r'}:${t}`
let i=this.L.get(s)
...
return n.length===o&&n[0]===c&&n[n.length-1]===h||i.ht(s),f}:r&&'object'==typeof r?i.ie(r,s):r},ownKeys:t=>Reflect.ownKeys(t),has:(t,e)=>Reflect.has(t,e),set(t,e,n){i.m&&return1,'symbol'==typeof e&&return1
const o=Reflect.has(t,e),r=o?Reflect.get(t,e):0
if(n&&'object'==typeof n&&i.ie(n,s),!o){try{Reflect.defineProperty(t,e,{configurable:1,enumerable:1,writable:1,value:n})}catch{Reflect.set(t,e,n)}return i.ht(s),1}return r===n||(Reflect.set(t,e,n),i.ht(s)),1},deleteProperty:(t,e)=>Reflect.deleteProperty(t,e)})
return this.kt.set(e,n),n}ot(e){const s=this
return new Proxy(e,{get(t,e,i){const n=Reflect.get(t,e,i)
return e===Symbol.iterator?n:('symbol'!=typeof e&&s.dt(e),n&&'object'==typeof n?s.ie(n,e):n)},ownKeys:t=>Reflect.ownKeys(t),has:(t,e)=>Reflect.has(t,e),set:(e,i,n,o)=>{if(s.m&&return1,i===Symbol.iterator&&t(e))return n
const r=Reflect.get(e,i)
if(r===n&&return1,Reflect.has(e,i))Reflect.set(e,i,n,o)
else try{Reflect.defineProperty(e,i,{configurable:1,enumerable:1,writable:1,value:n})}catch{Reflect.set(e,i,n,o)}if(this.ht(i),this._&&'$props'!==i){const t=e.$props
t&&(t[i]=n)
const s=this.R[i]
s&&!this.$&&(this.$=1,this.Y(()=>s.call(this.tt(),n,r)),this.$=0)}return1}})}tt(t=1){const e={$log(...t){},$destroy:()=>this.destroy(),$forceUpdate:()=>this.ft(),$addCleanupFunction:t=>this.et(t),$nextTick:t=>t?(this.K.push(t),void(this.U||queueMicrotask(()=>{if(!this.U&&this.K.length){const t=this.K.splice(0,this.K.length)
...
let e=this.T.get(s)
e||(e=new Set,this.T.set(s,e)),e.add(this.C)}return t[s]}return s in this.O?this.ut(s):s in e?e[s]:this.rt[s]},set:(t,e,s)=>(this.F||(this.st[e]=s),1)})}lt(t,e){const s=this,n=e?this.Vt(e):null,o=n?new Set(i(n)):new Set,r='0'!=typeof window?window:0,c='0'!=typeof document?document:0,h=this.framework.te(),f=!!h.sandboxExpressions,l=new Set((h.allowGlobals||[]).map(t=>t+'')),u=t=>{if(!t)return t
...
return new Proxy({},{get:(t,e)=>n&&e in n?n[e]:e in s.st?s.st[e]:e in s.O?s.ut(e):e in s.rt?s.rt[e]:e in w?w[e]:0,set:(t,e,i)=>(n&&o.has(e)?n[e]=i:s.st[e]=i,1),has:(t,e)=>!(!n||!(e in n))||e in s.st||e in s.O||e in s.rt||e in w})}Nt(t,e,s,i,n){const o=this,r=o.Tt(s,t),c={type:'custom',expression:s,customDirective:i}
...
let p
t.parentNode?.insertBefore(y,t),t[h]===f?(p=a.createElement('div'),p.style[r]='contents',p.appendChild(t.content.cloneNode(1)),t.parentNode?.removeChild(t)):(p=t,t.parentNode?.removeChild(t))
...
if('0'!=typeof Map&&t instanceof Map)return{list:e(t.values()),keys:e(t.keys())}
if('0'!=typeof Set&&t instanceof Set)return{list:e(t.values()),keys:null}
if(t&&'function'==typeof t[Symbol.iterator])return{list:e(t),keys:null}
if(t&&'object'==typeof t){const e=i(t)
...
for(let s=e;s<i.length;s++){const e=p.cloneNode(1)
...
return this.le.set(e,t),this},this.de=t=>this.le.get(t.toLowerCase()),this.Lt=t=>this.fe.get(t),this.te=()=>this.he,this.init=(t={})=>{this.he={container:'body',debug:0,staticDirectives:1,...t},'boolean'==typeof this.he.staticDirectives&&(u=this.he.staticDirectives)
...
e.id=t,e.textContent=`[${y}-show],[${y}-if],[${y}-else],[${y}-else-if],[${y}\\:show],[${y}\\:if],[${y}\\:else],[${y}\\:else-if]{display:none;}`,a.head.appendChild(e)}}me(t){this.$e||'0'==typeof MutationObserver||(this.$e=new MutationObserver(t=>{for(const e of t)if('childList'===e.type){for(let t=0;t<e.addedNodes.length;t++){const s=e.addedNodes[t]
...
t&&'COMPONENT'===t[h]&&'source'===e.attributeName&&this.ke(t)}this.ge()}),this.$e.observe(t,{childList:1,subtree:1,attributes:1,attributeFilter:['source']}))}ke(t){const e=(t.getAttribute('source')||'').trim(),s=this.bt(t)
...
if(h){if(c=h,i)try{r=Function('ctx','with(ctx){return ('+h+')}')(i.getContext(1))}catch{r=null}else try{r=Function('return ('+h+')')()}catch{r=null}if(r&&'object'==typeof r)for(const t in r)t in o||(o[t]=r[t]+'')
...
for(const t of i)e.addEventListener(t,s,1)
this.ue=1}ee(t,e,s){let i=this.ae.get(t)
...
'0'!=typeof window&&(window.XTool=e)

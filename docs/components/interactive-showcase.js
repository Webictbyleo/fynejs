...
XTool.registerComponent({
  ...
  methods: {
    ...
    refreshWeather() {
      ...
      const data = this.weatherData[this.currentWeather];
    ...
    adjustTimer(type, amount) {
      ...
      const displays = document.querySelectorAll('.timer-number-display');
    ...
    trackPhotoScroll() {
      ...
      if (container) {
        ...
        const cardWidth = container.children[0]?.offsetWidth || containerWidth;
